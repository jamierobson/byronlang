...
### Implementation example: DoublyLinkedList
// todo: Make idiomatic - this is an incredibly old example
...
pub struct DoubleLinkedList<T> {
    next: Option<&var DoubleLinkedList<T>>,
    previous: Option<&DoubleLinkedList<T>>,
    value: T
...
pub struct DoublyLinkedList<T> {
    next: Option<*DoublyLinkedList<T>>,
    unsafe previous: Option<&DoublyLinkedList<T>>,
    value: Option<*T>,
